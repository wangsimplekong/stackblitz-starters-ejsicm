...
const DEFAULT_HIDDEN_FILES = [/\/node_modules\//, /\/\.next/, /\/\.astro/, /\/\.hidden/, /^\.hidden/];
    ...
    return (
      <div 
        className={classNames(
          'text-sm overflow-y-auto max-h-full',
          'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-bolt-elements-item-backgroundActive hover:scrollbar-thumb-bolt-elements-item-backgroundActive/70',
          className
        )}
      >
